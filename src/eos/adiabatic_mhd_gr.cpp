...
void EquationOfState::FastMagnetosonicSpeedsGR(Real wgas, Real pgas, Real u0, Real u1,
  ...
  *p_lambda_minus = (a1 >= 0.0) ? (-a1 - s) / 2.0 : -2.0 * a0 / (a1 - s);
  ...
  if ( pmy_block->pfield->isnan_volatile(*p_lambda_plus) || pmy_block->pfield->check_nan(*p_lambda_plus) ||
      pmy_block->pfield->isnan_volatile(*p_lambda_minus) || pmy_block->pfield->check_nan(*p_lambda_minus) ){
