...
Real oo18 = oo17 * -1;
Real oo19 = 1 + oo18;
Real oo20 = std::sqrt(oo19);
Real oo21 = oo20 * oo17;
Real oo22 = -1 + oo20;
Real oo23 = v2x * v2x;
Real oo24 = v2y * v2y;
Real oo25 = oo23 + oo24;
Real oo26 = oo22 * (oo25 * -1);
Real oo27 = oo21 + oo26;
Real oo28 = std::pow(oo27, -1);
Real oo29 = oo13 + xi2x;
Real oo30 = oo15 + xi2y;
Real oo31 = xi1x * -1;
Real oo32 = oo31 + x;
Real oo33 = xi2x * -1;
Real oo34 = oo33 + x;
Real oo35 = std::pow(oo1, -1);
Real oo36 = std::pow(oo4, -1);
Real oo37 = xi1y * -1;
Real oo38 = std::pow(oo17, -1);
Real oo39 = std::pow(oo20, -1);
Real oo40 = xi2y * -1;
Real x0BH1 = (t + oo12 * ((v1x * oo14 + v1y * oo16) * oo1)) * oo4;
Real x0BH2 = (t + oo28 * ((v2x * oo29 + v2y * oo30) * oo17)) * oo20;
Real x1BH1 = (oo32 * (oo4 * oo1) - v1y * ((v1x * oo16 + v1y * oo32) * oo6)) * oo12;
Real x1BH2 = (oo20 * (oo34 * oo17) - v2y * ((v2x * oo30 + v2y * oo34) * oo22)) * oo28;
Real x2BH1 = (oo37 + (y + (-1 + oo36) * (v1x * ((v1y * oo14 + (oo37 + y) * v1x) * oo35)))) * std::pow(1 - oo36 * (oo6 * (oo9 * oo35)), -1);
Real x2BH2 = (oo40 + (y + (-1 + oo39) * (v2x * ((v2y * oo29 + (oo40 + y) * v2x) * oo38)))) * std::pow(1 - oo25 * (oo38 * (oo39 * oo22)), -1);
Real x3BH1 = z;
Real x3BH2 = z;


Real o1 = 1.4142135623730951;
Real o2 = std::pow(o1, -1);
Real o3 = v1 * v1;
Real o4 = o3 * -1;
Real o5 = 1 + o4;
Real o6 = (o5 * o5) * o5;
...
Real o14 = o13 + o8;
Real o15 = o14 * o14;
Real o16 = std::pow(o3, -1);
Real o17 = std::pow(o7, -1);
Real o18 = o16 * (o17 * (o9 * o12));
Real o19 = -1 + o18;
Real o20 = ((o19 * o19) * o19) * o19;
Real o21 = std::pow(o20, -1);
Real o22 = o9 * (v1 * o12);
Real o23 = (((v1 * v1) * v1) * v1) * v1;
Real o24 = o10 + (o11 + o7);
Real o25 = o24 * o23;
Real o26 = (v1 * v1) * v1;
Real o27 = o9 * o10;
Real o28 = o9 * o11;
Real o29 = o10 + (o11 + (o27 + (o28 + o7)));
Real o30 = o26 * (o29 * -1);
Real o31 = o22 + (o25 + o30);
Real o32 = a1 * a1;
Real o33 = o32 * -1;
Real o34 = x1BH1 * x1BH1;
Real o35 = x2BH1 * x2BH1;
Real o36 = x3BH1 * x3BH1;
Real o37 = o33 + (o34 + (o35 + o36));
Real o38 = o37 * (R0 * -1);
Real o39 = o38 + R1;
Real o40 = std::pow(E, o39);
Real o41 = 1 + o40;
Real o42 = std::log(o41);
Real o43 = o32 * (o36 * 4);
Real o44 = o33 + (o34 + (o35 + (o36 + o42)));
Real o45 = o44 * o44;
Real o46 = o43 + o45;
Real o47 = std::sqrt(o46);
Real o48 = o33 + (o34 + (o35 + (o36 + (o42 + o47))));
Real o49 = std::pow(o48, 1.5);
Real o50 = o36 * o32;
Real o51 = o48 * o48;
Real o52 = o51 * 0.25;
Real o53 = o50 + o52;
Real o54 = std::pow(o53, -1);
Real o55 = -1 + o3;
Real o56 = x2BH1 * a1;
Real o57 = std::sqrt(o48);
Real o58 = o57 * (x1BH1 * o2);
Real o59 = o56 + o58;
Real o60 = o59 * o59;
Real o61 = o48 * 0.5;
Real o62 = o32 + o61;
Real o63 = o62 * o62;
Real o64 = std::pow(o63, -1);
Real o65 = std::pow(o5, 1.5);
Real o66 = o55 * o55;
Real o67 = std::pow(o66, -1);
Real o68 = o12 * (o16 * (o17 * (o9 * -1)));
Real o69 = 1 + o68;
Real o70 = a1 * (x1BH1 * -1);
Real o71 = o57 * (x2BH1 * o2);
Real o72 = o70 + o71;
Real o73 = o69 * o69;
Real o74 = o72 * o72;
Real o75 = std::pow(o62, -1);
Real o76 = std::pow(o23, -1);
Real o77 = std::pow(o65, -1);
Real o78 = v2 * v2;
Real o79 = o78 * -1;
Real o80 = 1 + o79;
Real o81 = (o80 * o80) * o80;
Real o82 = std::sqrt(o80);
Real o83 = o82 * o78;
Real o84 = -1 + o82;
Real o85 = v2x * v2x;
Real o86 = v2y * v2y;
...
Real o89 = o83 + o88;
Real o90 = o89 * o89;
Real o91 = std::pow(o78, -1);
Real o92 = std::pow(o82, -1);
Real o93 = o87 * (o91 * (o92 * o84));
Real o94 = -1 + o93;
Real o95 = ((o94 * o94) * o94) * o94;
Real o96 = std::pow(o95, -1);
Real o97 = o87 * (v2 * o84);
Real o98 = (((v2 * v2) * v2) * v2) * v2;
Real o99 = o82 + (o85 + o86);
Real o100 = o99 * o98;
Real o101 = (v2 * v2) * v2;
Real o102 = o85 * o84;
Real o103 = o86 * o84;
Real o104 = o102 + (o103 + (o82 + (o85 + o86)));
Real o105 = o101 * (o104 * -1);
Real o106 = o100 + (o105 + o97);
Real o107 = a2 * a2;
Real o108 = o107 * -1;
Real o109 = x1BH2 * x1BH2;
Real o110 = x2BH2 * x2BH2;
Real o111 = x3BH2 * x3BH2;
Real o112 = o108 + (o109 + (o110 + o111));
Real o113 = o112 * (R0 * -1);
Real o114 = o113 + R1;
Real o115 = std::pow(E, o114);
Real o116 = 1 + o115;
Real o117 = std::log(o116);
Real o118 = o107 * (o111 * 4);
Real o119 = o108 + (o109 + (o110 + (o111 + o117)));
Real o120 = o119 * o119;
Real o121 = o118 + o120;
Real o122 = std::sqrt(o121);
Real o123 = o108 + (o109 + (o110 + (o111 + (o117 + o122))));
Real o124 = std::pow(o123, 1.5);
Real o125 = o111 * o107;
Real o126 = o123 * o123;
Real o127 = o126 * 0.25;
Real o128 = o125 + o127;
Real o129 = std::pow(o128, -1);
Real o130 = -1 + o78;
Real o131 = x2BH2 * a2;
Real o132 = std::sqrt(o123);
Real o133 = o2 * (x1BH2 * o132);
Real o134 = o131 + o133;
Real o135 = o134 * o134;
Real o136 = o123 * 0.5;
Real o137 = o107 + o136;
Real o138 = o137 * o137;
Real o139 = std::pow(o138, -1);
Real o140 = std::pow(o80, 1.5);
Real o141 = o130 * o130;
Real o142 = std::pow(o141, -1);
Real o143 = o84 * (o87 * (o91 * (o92 * -1)));
Real o144 = 1 + o143;
Real o145 = a2 * (x1BH2 * -1);
Real o146 = o2 * (x2BH2 * o132);
Real o147 = o145 + o146;
Real o148 = o144 * o144;
Real o149 = o147 * o147;
Real o150 = std::pow(o137, -1);
Real o151 = std::pow(o98, -1);
Real o152 = std::pow(o140, -1);
Real o153 = std::pow(o69, -1);
Real o154 = o19 * o19;
Real o155 = std::pow(o154, -1);
Real o156 = -1 + o17;
Real o157 = o156 * (o16 * o11);
Real o158 = 1 + o157;
Real o159 = std::pow(o14, -1);
Real o160 = std::pow(o144, -1);
Real o161 = o94 * o94;
Real o162 = std::pow(o161, -1);
Real o163 = -1 + o92;
Real o164 = o86 * (o91 * o163);
Real o165 = 1 + o164;
Real o166 = std::pow(o89, -1);
Real o167 = std::pow(o73, -1);
Real o168 = o9 * o9;
Real o169 = std::pow(o15, -1);
Real o170 = std::pow(o148, -1);
Real o171 = o84 * o84;
Real o172 = std::pow(o90, -1);
Real o173 = o156 * (o16 * o10);
Real o174 = 1 + o173;
Real o175 = o85 * (o91 * o163);
Real o176 = 1 + o175;
result[0] = -1 + (m1 * (o11 * (o2 * (o21 * (o49 * (o54 * (o64 * (o73 * o74))))))) + (m2 * (o124 * (o129 * (o139 * (o148 * (o149 * (o2 * (o86 * o96))))))) + (m1 * (o15 * (o2 * (o21 * (std::pow(o31, 2) * (o49 * (o54 * (std::pow(o6, -1) * std::pow(v1, -10)))))))) + (m1 * (o10 * (o15 * (o2 * (o21 * (o49 * (o54 * (std::pow(o55, -4) * (o6 * (o60 * (o64 * std::pow(v1, -4))))))))))) + (m1 * (o1 * (o15 * (o21 * (o31 * (o49 * (o54 * (o59 * (o67 * (o75 * (std::pow(v1, -7) * v1x)))))))))) + (m1 * (o1 * (o14 * (o21 * (o31 * (o49 * (o54 * (o69 * (o72 * (o75 * (o76 * (o77 * v1y))))))))))) + (m1 * (o1 * (o14 * (o16 * (o21 * (o49 * (o54 * (o59 * (o64 * (o65 * (o67 * (o69 * (o72 * (v1x * v1y))))))))))))) + (m2 * (std::pow(o106, 2) * (o124 * (o129 * (o2 * (std::pow(o81, -1) * (o90 * (o96 * std::pow(v2, -10)))))))) + (m2 * (o124 * (o129 * (std::pow(o130, -4) * (o135 * (o139 * (o2 * (o81 * (o85 * (o90 * (o96 * std::pow(v2, -4))))))))))) + (m2 * (o1 * (o106 * (o124 * (o129 * (o134 * (o142 * (o150 * (o90 * (o96 * (std::pow(v2, -7) * v2x)))))))))) + (m2 * (o1 * (o106 * (o124 * (o129 * (o144 * (o147 * (o150 * (o151 * (o152 * (o89 * (o96 * v2y))))))))))) + m2 * (o1 * (o124 * (o129 * (o134 * (o139 * (o140 * (o142 * (o144 * (o147 * (o89 * (o91 * (o96 * (v2x * v2y))))))))))))))))))))))));
